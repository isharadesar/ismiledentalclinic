...
class TeamindexController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $education = Education::where('team_id',$id)->get();
        $experience = Experience::where('team_id',$id)->get();
        return view('backend.team.team-index',compact('teams','education','experience'));
